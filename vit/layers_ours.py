# Copied from https://github.com/hila-chefer/Transformer-Explainability/blob/main/modules/layers_ours.py
...
def safe_divide(a, b, dt=torch.float32):
    den = b.clamp(min=1e-9) + b.clamp(max=1e-9)
    den = den + den.eq(0).type(dt) * 1e-9
    return a / den * b.ne(0).type(dt)
